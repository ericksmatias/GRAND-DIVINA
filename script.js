...
const galleryData = {
    'espacos': [
        { img: 'assets/panmeireles.mp4', title: 'Salão varanda (Capacidade 200 pessoas)', desc: `Ideal para Eventos Corporativos e Sociais (Recepção de Casamentos & Aniversários)
